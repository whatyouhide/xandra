defmodule Xandra.Connection do
  ...
  # ERROR
  defp decode_response(<<_cql_version, _flags, _stream_id::16, 0x00>>, body) do
  ...
  # READY
  defp decode_response(<<_cql_version, _flags, _stream_id::16, 0x02>>, "") do
    :ok
  end

  # SUPPORTED
  defp decode_response(<<_cql_version, _flags, _stream_id::16, 0x06>>, body) do
    {content, ""} = decode_string_multimap(body)
    content
  end

  # RESULT
  defp decode_response(<<_cql_version, _flags, _stream_id::16, 0x08>>, body) do
